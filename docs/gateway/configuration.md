...
<AccordionGroup>
  ...
  <Accordion title="Set up group chat mention gating">
    Group messages default to **require mention**. Configure trigger patterns per agent, and keep visible room replies automatic unless you intentionally want tool-only room output:
