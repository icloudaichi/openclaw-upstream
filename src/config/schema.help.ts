...
export const FIELD_HELP: Record<string, string> = {
  ...
  "messages.groupChat.visibleReplies":
    'Overrides visible source replies for group/channel conversations. Defaults to "automatic" when no global visible reply policy is set. "message_tool" keeps normal final replies private and requires message(action=send) for room output; "automatic" posts normal replies as before.',
  "messages.queue":
